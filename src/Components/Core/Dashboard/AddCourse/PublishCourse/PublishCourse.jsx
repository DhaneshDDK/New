        ...
        <div className="my-6 mb-8">
          <label htmlFor="public" className="inline-flex items-center text-lg">
            <input
              ...
              id="public"
              {...register("public")}
              className="border-gray-300 h-4 w-4 cursor-pointer rounded bg-richblack-900 text-yellow-200 accent-yellow-25"
            />
            <span className="ml-2 text-richblack-400 font-medium">
